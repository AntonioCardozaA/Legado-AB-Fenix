...
class WasherActionPlanPromptBuilder
{
    ...
    public function build(array $context): array
    {
        ...
        $systemPrompt = implode("\n", [
            ...
            'Follow the priority order inside technical_context: same component and washer, same component type in the same washer, same component in other washers, similar failures, then manuals or knowledge-base documents.',
