...
class GeneratePasteurizadoraActionPlan implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(PasteurizadoraActionPlanGenerator $generator): void
    {
    ...
    public function failed(Throwable $exception): void
    {
        ...
        if ($event) {
            ...
            app(PasteurizadoraActionPlanGenerator::class)->createFailureFallback($event, $exception);
        }

        Log::warning('Failed to generate pasteurizadora AI action plan.', [
