...
@php
    ...
    $backUrl = request()->input('redirect_to') ?: $analisisRoute('show', $analisis->id);
    $cancelUrl = $backUrl;
    ...
    $estadoBadges = [
        ...
        'Requiere revisión' => 'bg-yellow-100 text-yellow-800 border-yellow-200',
        'Desgaste moderado' => 'bg-orange-100 text-orange-800 border-orange-200',
