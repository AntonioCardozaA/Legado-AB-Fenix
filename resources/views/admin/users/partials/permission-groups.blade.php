...
>
    <div class="mb-4 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
            <h3 class="text-sm font-bold text-slate-900">Permisos personalizados</h3>
            <p class="text-xs text-slate-500">Cuando esta capa esta activa, estas casillas mandan sobre las rutas controladas del sistema.</p>
            @if($autoSaveUrl)
        ...
        <label class="inline-flex items-start gap-3 rounded border border-blue-100 bg-blue-50 px-3 py-2 text-sm text-blue-900">
            ...
            >
            <span>
                <span class="block font-semibold">Aplicar permisos personalizados</span>
                <span class="block text-xs text-blue-700">Si esta apagado, el usuario conserva los accesos de su rol.</span>
            </span>
        </label>
    </div>
