...
<div class="historico-container">
    ...
    {{-- Gráfica de Avance por Módulo/Componente --}}
    @if(count($componentesModulos) > 0)
    <div class="grafica-section">
        <div class="grafica-title">
            <i class="fas fa-chart-bar text-blue-600"></i>
            GRÁFICA DE AVANCE POR MÓDULO Y COMPONENTE
        </div>
        ...
        <div class="grafica-vertical-container">
            @foreach($componentesModulos->take(12) as $item) {{-- Limitar a 12 para mejor visualización --}}
                ...
                <div class="grafica-columna">
                    ...
                    <div class="grafica-etiqueta" title="{{ $item['nombre'] }}">
                        {{ $item['nombre'] }}<br>M{{ $item['modulo'] }}
                    </div>
                </div>
            @endforeach
        </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">
                        <span id="modalModulo" class="font-semibold"></span>
                    </p>
                </div>
            </div>
...
function verDetalleComponente(codigo, nombre, modulo, revisado, total) {
    ...
    document.getElementById('modalComponenteDesc').textContent = `${nombre} - Módulo ${modulo}`;
