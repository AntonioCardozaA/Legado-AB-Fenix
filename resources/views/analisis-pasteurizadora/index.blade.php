...
<style>
    ...
    /* MODAL PARA VER MÁS PASTEURIZADORAS */
    .lineas-modal {
        display: none;
        position: fixed;
        top: 0;
    ...
    /* ESTILOS PARA SECCIÓN DE TODAS LAS PASTEURIZADORAS */
...
<div class="max-w-full mx-auto px-4 py-6">
    ...
    @php
        ...
        // Arrays de componentes por línea para pasteurizadora (L-03 a L-14)
        ...
        // Arrays de módulos por línea (1-16 por línea)
        $modulosPorLineaArray = [
            'L-03' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-04' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-05' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-06' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-07' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-08' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-09' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-10' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-11' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-12' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-13' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
            'L-14' => ['Módulo 1', 'Módulo 2', 'Módulo 3', 'Módulo 4', 'Módulo 5', 'Módulo 6', 'Módulo 7', 'Módulo 8', 'Módulo 9', 'Módulo 10', 'Módulo 11', 'Módulo 12', 'Módulo 13', 'Módulo 14', 'Módulo 15', 'Módulo 16'],
        ];
        
        // Filtrar solo las pasteurizadoras que queremos mostrar (L-03 a L-14)
        $pasteurizadorasPermitidas = ['L-03', 'L-04', 'L-05', 'L-06', 'L-07', 'L-08', 'L-09', 'L-10', 'L-11', 'L-12', 'L-13', 'L-14'];
        
        // Determinar si mostrar todas las pasteurizadoras (por defecto TRUE)
        ...
        // Todas las pasteurizadoras para el modal de "Ver más"
        $todasLasLineas = $lineas->filter(function($linea) use ($pasteurizadorasPermitidas) {
            return !in_array($linea->nombre, $pasteurizadorasPermitidas) && $linea->nombre != null;
        })->values();
        
        // Obtener todos los componentes únicos
        $todosComponentes = [];
        foreach ($componentesPorLineaArray as $lineaComponentes) {
            foreach ($lineaComponentes as $key => $nombre) {
                $todosComponentes[$key] = $nombre;
            }
        }
    @endphp
    ...
    @if(isset($lineas) && $lineas->count() > 0)
        <div class="filters-section">
            {{-- LÍNEAS: con las pasteurizadoras específicas L-03 a L-14 --}}
            ...
            <form method="GET" action="{{ route('analisis-pasteurizadora.index') }}" id="filterForm">
                <div class="lineas-grid">
                    ...
                    <input type="hidden" name="componente" value="{{ request('componente') }}">
                ...
                <div class="filters-row">
                    <div class="filter-link {{ request()->has('modulo') || request()->has('componente') || request()->has('fecha') ? 'active' : '' }}" 
                    ...
                    <a href="{{ route('analisis-pasteurizadora.index', ['linea_id' => 'todas']) }}" class="btn-clear">
                ...
                <div id="advancedFiltersPanel" class="advanced-filters-panel {{ request()->has('modulo') || request()->has('componente') || request()->has('fecha') || request()->has('estado') ? 'show' : '' }}">
                    <div class="advanced-filters-grid">
                        <div class="filter-group">
                            <label><i class="fas fa-cubes mr-1"></i> Módulo</label>
                        ...
                        <div class="filter-group">
                            ...
                            <select name="componente" class="filter-select">
                                ...
                                @foreach($todosComponentes as $key => $nombre)
                                    <option value="{{ $key }}" {{ request('componente') == $key ? 'selected' : '' }}>
                                        {{ $nombre }}
                                    </option>
                                @endforeach
                            </select>
    ...
    <div id="lineasModal" class="lineas-modal">
        <div class="lineas-modal-content">
            <div class="lineas-modal-header">
                <h3>
                    <i class="fas fa-temperature-high"></i>
                    Otras líneas de pasteurizadora
                </h3>
                ...
                <div class="lineas-modal-grid">
                    ...
                    @if($todasLasLineas->count() == 0)
                        <p class="text-gray-500 col-span-full text-center py-8">
                            No hay más pasteurizadoras disponibles
                        </p>
                    @endif
                </div>
            </div>
    ...
    <h1 class="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
        <img src="{{ asset('images/Diagramas-Pasteurizadora/linea7.png') }}" alt="Diagrama Pasteurizadora">
    </h1>
            ...
            <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 p-6 border-t-4 border-red-600 flex items-center justify-between min-h-[120px]">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-red-600 mt-2">
                        {{ ($estadisticas['danado_requiere'] ?? 0) }}
                    </h3>
                </div>
    ...
    {{-- SECCIÓN PRINCIPAL - MUESTRA TODAS LAS PASTEURIZADORAS O UNA SOLA --}}
    @if($mostrarTodas)
        {{-- MOSTRAR TODAS LAS PASTEURIZADORAS CON LAS MISMAS PROPIEDADES --}}
            ...
            @foreach($lineasFiltradas as $linea)
                @php
                    ...
                    if (isset($componentesPorLineaArray[$linea->nombre])) {
                        foreach ($componentesPorLineaArray[$linea->nombre] as $codigo => $nombre) {
                            $componentesLinea->push((object)[
                                ...
                                'nombre' => $nombre,
                                'codigo' => $codigo,
                                'icono'  => asset("images/componentes-pasteurizadora/{$codigo}.png"),
                            ]);
                        }
                    }
                    
                    // Obtener módulos específicos para esta línea (1-16)
                    $modulosLinea = collect();
                    if (isset($modulosPorLineaArray[$linea->nombre])) {
                        $modulosLinea = collect($modulosPorLineaArray[$linea->nombre]);
                    }
                    ...
                    foreach ($analisisLinea as $item) {
                        ...
                        $modulo = $item->modulo;
                        $moduloVista = "Módulo {$modulo}";
                        $componenteCodigo = $item->componente;
                        
                        if (!isset($analisisAgrupadosLinea[$moduloVista][$componenteCodigo])) {
                            $analisisAgrupadosLinea[$moduloVista][$componenteCodigo] = collect();
                        }
                        
                        $analisisAgrupadosLinea[$moduloVista][$componenteCodigo]->push($item);
                        
                        // Actualizar conteo de estados
                        if (isset($conteoEstadosComponente[$componenteCodigo])) {
                            $estado = $item->estado ?? 'Buen estado';
                            
                            if ($estado === 'Cambiado') {
                                $conteoEstadosComponente[$componenteCodigo]['changed']++;
                                $conteoEstadosComponente[$componenteCodigo]['empty']--;
                            } 
                            elseif ($estado === 'Dañado - Requiere cambio') {
                                $conteoEstadosComponente[$componenteCodigo]['danger']++;
                                $conteoEstadosComponente[$componenteCodigo]['empty']--;
                            } 
                            elseif (str_contains($estado, 'Desgaste')) {
                                $conteoEstadosComponente[$componenteCodigo]['warning']++;
                                $conteoEstadosComponente[$componenteCodigo]['empty']--;
                            } 
                            else {
                                $conteoEstadosComponente[$componenteCodigo]['ok']++;
                                $conteoEstadosComponente[$componenteCodigo]['empty']--;
                            }
                        }
                    }
                ...
                @if($componentesLinea->count() > 0 && $modulosLinea->count() > 0)
                    <div class="pasteurizadora-card">
                        <div class="pasteurizadora-card-header">
                            <div class="w-12 h-12">
                                <img src="{{ asset('images/icono-pasteurizadora.png') }}" alt="Icono" class="w-full h-full object-contain">
                            </div>
                            <div>
                                <h3>{{ $linea->nombre }}</h3>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="w-full compact-table border-collapse">
                                    ...
                                    <tr class="bg-gray-50 border-b border-gray-200">
                                        <th class="sticky-left cell-header text-blue-900 font-bold px-3 py-2 border text-center whitespace-nowrap text-sm">
                                            <div class="modulo-header">
                                                <div class="modulo-name">MÓDULO</div>
                                                <div class="modulo-label">COMPONENTE</div>
                                            </div>
                                        </th>
                                        @foreach($componentesLinea as $c)
                                ...
                                <tbody>
                                    @foreach($modulosLinea as $m)
                                        @php
                                            $moduloNumero = str_replace('Módulo ', '', $m);
                                            $conteoModulo = [
                                                'total' => 0,
                                                'ok' => 0,
                                                'warning' => 0,
                                            ...
                                            foreach($componentesLinea as $c) {
                                                if(isset($analisisAgrupadosLinea[$m][$c->id])) {
                                                    $conteoModulo['total']++;
                                                    $primerRegistro = $analisisAgrupadosLinea[$m][$c->id]->sortByDesc('fecha_analisis')->first();
                                                    $estado = $primerRegistro->estado ?? 'Buen estado';
                                                    
                                                    if ($estado === 'Cambiado') {
                                                        $conteoModulo['changed']++;
                                                    } 
                                                    elseif ($estado === 'Dañado - Requiere cambio') {
                                                        $conteoModulo['danger']++;
                                                    } 
                                                    elseif (str_contains($estado, 'Desgaste')) {
                                                        $conteoModulo['warning']++;
                                                    } 
                                                    else {
                                                        $conteoModulo['ok']++;
                                                    }
                                        ...
                                        <tr>
                                            <th class="sticky-left cell-header text-blue-900 font-bold px-3 py-2 border text-center whitespace-nowrap text-sm align-top">
                                                <div class="modulo-header">
                                                    <div class="modulo-name">{{ $m }}</div>
                                                    
                                                    <div class="text-xs text-gray-500 mt-1">
                                                        {{ $conteoModulo['total'] }}/{{ count($componentesLinea) }}
                                                    </div>
                                                </div>
                                            </th>
                                            ...
                                            @foreach($componentesLinea as $c)
                                                @php
                                                    $registros = $analisisAgrupadosLinea[$m][$c->id] ?? collect();
                                                    ...
                                                    if(isset($registro->created_at) && $registro->created_at->gt(now()->subDays(3))) {
                                                        $isNew = true;
                                                    }
                                                ...
                                                <td class="border px-3 py-2 align-top {{ $hasData ? $color : 'cell-empty' }} {{ $hasData ? 'analysis-cell' : 'analysis-cell no-data' }}"
                                                    ...
                                                    onclick="openAnalysisDetail({{ json_encode([
                                                        'id' => $registro->id,
                                                        'linea' => optional($registro->linea)->nombre ?? $linea->nombre,
                                                        'modulo' => $moduloNumero,
                                                        'componente' => $registro->componente_nombre ?? $c->nombre,
                                                        'componente_codigo' => $registro->componente ?? $c->id,
                                                        ...
                                                        'imagenes' => $imagenes ?? [],
                                                        'color' => $color,
                                                        'create_at' => isset($registro->created_at) ? $registro->created_at->format('d/m/Y H:i') : '',
                                                        'updated_at' => isset($registro->updated_at) ? $registro->updated_at->format('d/m/Y H:i') : '',
                                                        'is_new' => $isNew,
                                                        'total_historial' => $totalHistorial,
                                                        'edit' => route('analisis-pasteurizadora.edit', ['analisispasteurizadora' => $registro->id]),
                                                        'historial' => route('analisis-pasteurizadora.historial', [
                                                            'linea_id' => $registro->linea_id ?? $linea->id,
                                                            'modulo' => $moduloNumero,
                                                            'componente' => $c->id
                                                        ])
                                                    ]) }})"
                                                    ...
                                                    @if($hasData)
                                                        {{-- BADGE DE REGISTRO RESUELTO --}}
                                                        @if(isset($registro->resuelto_por_cambio) && $registro->resuelto_por_cambio)
                                                            <div class="badge-resuelto">
                                                                <i class="fas fa-check-circle"></i>
                                                                <span>RESUELTO</span>
                                                                @if(isset($registro->fecha_resolucion))
                                                                    <span class="ml-1 opacity-75">{{ $registro->fecha_resolucion->format('d/m') }}</span>
                                                                @endif
                                                            </div>
                                                        @endif
                                                        ...
                                                        <div class="space-y-2">
                                                            ...
                                                            @if($registro->lado)
                                                                <div class="mb-2">
                                                                    <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium {{ $registro->lado === 'VAPOR' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800' }}">
                                                                        <i class="fas {{ $registro->lado === 'VAPOR' ? 'fa-wind' : 'fa-walking' }} mr-1"></i>
                                                                        {{ $registro->lado }}
                                                                    </span>
                                                                </div>
                                                            @endif
                                                            ...
                                                            <div class="flex flex-col gap-1 mt-3">
                                                                ...
                                                                @endif
                                                                <a href="{{ route('analisis-pasteurizadora.create-quick', [
                                                                        'linea_id' => $linea->id,
                                                                        'modulo' => $moduloNumero,
                                                                        'componente' => $c->id,
    ...
    @else
        {{-- MOSTRAR UNA SOLA PASTEURIZADORA --}}
        @php
            ...
            if ($lineaMostrar && isset($componentesPorLineaArray[$lineaMostrar->nombre])) {
                foreach ($componentesPorLineaArray[$lineaMostrar->nombre] as $id => $nombre) {
                    $componentesParaTabla->push((object)[
                        'id'     => $id,
                        'nombre' => $nombre,
                        'icono'  => asset("images/componentes-pasteurizadora/{$id}.png"),
                    ]);
                }
            }
            ...
            if (request('componente')) {
                $componentesParaTabla = $componentesParaTabla
                    ->where('id', request('componente'))
                    ->values();
            }

            /* ===============================
            MÓDULOS PARA TABLA (1-16)
            =============================== */
            $modulosParaTabla = collect();

            if ($lineaMostrar && !empty($modulosPorLineaArray[$lineaMostrar->nombre])) {
                $modulosParaTabla = collect($modulosPorLineaArray[$lineaMostrar->nombre]);
            } elseif ($analisisCollection->count() > 0) {
                $modulosParaTabla = $analisisCollection
                    ->pluck('modulo')
                    ->map(function($m) {
                        return "Módulo {$m}";
                    })
            ...
            if ($modulosParaTabla->isEmpty() && $lineaMostrar) {
                $modulosParaTabla = collect($modulosPorLineaArray[$lineaMostrar->nombre] ?? []);
            }

            if (request('modulo')) {
                $moduloBuscado = "Módulo " . request('modulo');
                $modulosParaTabla = $modulosParaTabla
                    ->filter(fn($m) => $m == $moduloBuscado)
                    ->values();
            }
            ...
            foreach ($analisisCollection as $item) {
                ...
                if (!isset($analisisAgrupados[$moduloVista][$componenteCodigo])) {
                    $analisisAgrupados[$moduloVista][$componenteCodigo] = collect();
                }

                $analisisAgrupados[$moduloVista][$componenteCodigo]->push($item);
            }
        @endphp
        ...
        @if((isset($lineaMostrar) && $lineas->count() > 0) || ($analisisCollection->count() > 0))
            <div class="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-4 mt-2 text-blue-100 text-sm">
                                    @if(request('componente') && isset($todosComponentes))
                                        <span class="flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full">
                                            <i class="fas fa-cog text-xs"></i>
                                            {{ $todosComponentes[request('componente')] ?? request('componente') }}
                                        </span>
                                    @endif
                ...
                {{-- TABLA COMPACTA --}}
                @if(isset($componentesParaTabla) && isset($modulosParaTabla) && count($componentesParaTabla) > 0 && count($modulosParaTabla) > 0)
                                    ...
                                    @foreach($componentesParaTabla as $c)
                                        @php
                                            $conteoEstado = [
                                                ...
                                                'danger' => 0,
                                                'changed' => 0,
                                                'empty' => count($modulosParaTabla)
                                            ];
                                        @endphp

                                        @foreach($modulosParaTabla as $m)
                                            @if(isset($analisisAgrupados[$m][$c->id]))
                                                @php
                                                    $primerRegistro = $analisisAgrupados[$m][$c->id]->sortByDesc('fecha_analisis')->first();
                                                    $estado = $primerRegistro->estado ?? 'Buen estado';
                                    ...
                                    <tr>
                                        <th class="sticky-left cell-header text-blue-900 font-bold px-3 py-2 border text-center whitespace-nowrap text-sm align-top">
                                            <div class="modulo-header">
                                                <div class="modulo-name">{{ $m }}</div>
                                                <div class="text-xs text-gray-500 mt-1">
                                                    {{ $conteoModulo['total'] }}/{{ count($componentesParaTabla) }}
                                                </div>
                                            </div>
                                        </th>
                                        ...
                                        @foreach($componentesParaTabla as $c)
                                            @php
                                                $registros = $analisisAgrupados[$m][$c->id] ?? collect();
                                                $registro = $registros->sortByDesc('fecha_analisis')->first();
                                                $totalHistorial = $registros->count();
                                            ...
                                            <td class="border px-3 py-2 align-top {{ $hasData ? $color : 'cell-empty' }} {{ $hasData ? 'analysis-cell' : 'analysis-cell no-data' }}" 
                                                ...
                                                onclick="openAnalysisDetail({{ json_encode([
                                                    'id' => $registro->id,
                                                    'linea' => optional($registro->linea)->nombre ?? ($lineaMostrar->nombre ?? 'Sin nombre'),
                                                    'modulo' => $moduloNumero,
                                                    'componente' => $registro->componente_nombre ?? $c->nombre,
                                                    'componente_codigo' => $registro->componente ?? $c->id,
                                                    'lado' => $registro->lado ?? null,
                                                    ...
                                                    'is_new' => $isNew,
                                                    'total_historial' => $totalHistorial,
                                                    'edit_url' => route('analisis-pasteurizadora.edit', [
                                                        'analisispasteurizadora' => $registro->id
                                                    ]),
                                                 'historial_url' => route('analisis-pasteurizadora.historial', [
                                                    'linea_id' => $registro->linea_id ?? ($lineaMostrar->id ?? null),
                                                    'modulo' => $moduloNumero,
                                                    'componente' => $c->id
                                                ])
                                                ]) }})"
                ...
                @elseif(!$mostrarTodas)
                    ...
                    <div class="p-8 text-center text-gray-500">
                        ...
                        <p>No hay componentes o módulos para mostrar</p>
                        <p class="text-sm text-gray-400 mt-2">Selecciona una pasteurizadora para ver sus análisis</p>
                    </div>
                @endif
            </div>
        @else
            {{-- Si no hay línea seleccionada y no hay análisis, mostramos todas las pasteurizadoras vacías --}}
            @if($mostrarTodas)
                <div class="pasteurizadoras-section">
                    @foreach($lineasFiltradas as $linea)
                        @php
            ...
            @else
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-700 mb-2">Sistema de Análisis de Pasteurizadoras</h3>
                    <p class="text-gray-500 mb-6">Selecciona una línea para ver sus análisis detallados (L-03 a L-14)</p>
                        ...
                        @foreach($lineasFiltradas as $l)
                            <div class="bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 
                                ...
                                <div class="flex flex-col items-center">
                                    <i class="fas fa-temperature-high text-3xl text-blue-500 
                                              group-hover:scale-110 transition-transform mb-2"></i>
                                    <span class="font-bold text-gray-700">{{ $l->nombre }}</span>
                                    <span class="text-xs text-gray-500 mt-1">Pasteurizadora</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
...
{{-- MODAL DE DETALLES INDUSTRIAL (COPIADO DE LAVADORA Y ADAPTADO PARA PASTEURIZADORA) --}}
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center">
                        <i class="fas fa-temperature-high text-gray-600 text-sm"></i>
                    </div>
        ...
        <div class="p-8 overflow-auto max-h-[calc(90vh-100px)] bg-gray-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-lg p-5 border-l-4 border-gray-700 shadow-sm hover:shadow-md transition-all">
                    <div class="flex items-start gap-3">
                        <div class="bg-gray-100 p-3 rounded-lg">
                            <i class="fas fa-temperature-high text-gray-700 text-xl"></i>
                        </div>
                        <div class="flex-1">
                ...
                <div class="bg-white rounded-lg p-5 border-l-4 border-gray-700 shadow-sm hover:shadow-md transition-all">
                    <div class="flex items-start gap-3">
                        <div class="bg-gray-100 p-3 rounded-lg">
                            <i class="fas fa-cubes text-gray-700 text-xl"></i>
                        </div>
                        <div class="flex-1">
...
// FUNCIONES PRINCIPALES MEJORADAS (ADAPTADAS PARA PASTEURIZADORA)
function openAnalysisDetail(analysisData) {
    showLoading();
    currentAnalysisData = analysisData;
    
    document.getElementById('detail-linea').textContent = analysisData.linea;
    document.getElementById('detail-modulo').textContent = 'Módulo ' + analysisData.modulo;
